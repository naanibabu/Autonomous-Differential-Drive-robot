...
class Simplecontroller(Node):
    ...
    # This is for Teloperating with Keyboard 
    #def velCallback(self, msg):
        #robot_speed_ = np.array([[msg.linear.x],  
                                #[msg.angular.z]])  

        # Use pseudo-inverse instead of np.linalg.inv()
        #wheel_speed = np.matmul(np.linalg.pinv(self.speed_conversion_), robot_speed_)  
    ...
    # This is for Teleoperating using joystick here we use "TwistStamped" msg type
    def velCallback(self, msg):
